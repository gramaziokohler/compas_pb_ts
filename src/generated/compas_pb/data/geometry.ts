...
export const QuaternionData: MessageFns<QuaternionData> = {
  encode(
    ...
    if (message.w !== 0) {
      writer.uint32(25).double(message.w);
    }
    if (message.x !== 0) {
...
export const EllipseData: MessageFns<EllipseData> = {
  encode(
    ...
    if (message.major !== 0) {
      writer.uint32(25).double(message.major);
    }
    if (message.minor !== 0) {
      writer.uint32(33).double(message.minor);
    }
    if (message.frame !== undefined) {
...
export const ParabolaData: MessageFns<ParabolaData> = {
  encode(
    ...
    if (message.focal !== 0) {
      writer.uint32(25).double(message.focal);
    }
    if (message.frame !== undefined) {
      FrameData.encode(message.frame, writer.uint32(34).fork()).join();
    }
...
export const BoxData: MessageFns<BoxData> = {
  encode(
    ...
    if (message.xsize !== 0) {
      writer.uint32(33).double(message.xsize);
    }
    if (message.ysize !== 0) {
      writer.uint32(41).double(message.ysize);
    }
    if (message.zsize !== 0) {
      writer.uint32(49).double(message.zsize);
    }
    return writer;
  },
...
export const TorusData: MessageFns<TorusData> = {
  encode(
    ...
    if (message.radiusAxis !== 0) {
      writer.uint32(25).double(message.radiusAxis);
    }
    if (message.radiusPipe !== 0) {
      writer.uint32(33).double(message.radiusPipe);
    }
    if (message.frame !== undefined) {
      FrameData.encode(message.frame, writer.uint32(42).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.radiusAxis = reader.double();
          continue;
        }
        case 4: {
          if (tag !== 33) {
          ...
          message.radiusPipe = reader.double();
          continue;
        }
        case 5: {
          if (tag !== 42) {
